...
<link href="../css/bootstrap.min.css" rel="stylesheet">
  ...
  <div class="row">
    ...
    <div class="col-md-10 order-md-1 offset-md-1">
      <h4 class="mb-3">Cadastro de Personagens</h4>
      <form action="personagem.php" method="POST" class="needs-validation" novalidate>
        <div class="row">
            ...
            <div class="col-md-6 mb-3">
                ...
                <select name="idGame" class="custom-select d-block w-100" id="jogo" required>
                <?php
                  require_once '../bd/ConexaoBD.php';

                  $conexao = new ConexaoBD();

                  $result = $conexao->query("SELECT id, name FROM game");
